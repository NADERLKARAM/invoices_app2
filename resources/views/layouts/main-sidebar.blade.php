				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
                            ...
                            <li><a class="slide-item" href="{{ url('/' . $page='Invoice_Paid') }}">الفواتبر المدفوعة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='InvoiceUnPaid') }}">الفواتبر غير المدفوعة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='InvoicePartial') }}">الفواتبر المدفوعة جزئيا</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="{{ url('/' . $page='avatar') }}">صلحيات المستخدمين</a></li>
						</ul>
					</li>
